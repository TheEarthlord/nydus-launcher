...
def initialise_accounts(cfg, app):
    ...
    log_server("Nydus server starting up; creating a new allocation database. Authenticating the accounts found in {}".format(cfg.get_accounts_file()))
    ...
    alloc_engine = AllocEngine(cfg.get_alloc_file(), read_file=False)
